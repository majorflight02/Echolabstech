...
import com.Tremec.tremec.app.Results;

public class Step3 extends Activity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Step3 myThis = this;
        final ImageButton button = (ImageButton)findViewById(R.id.imageButton);
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivityForResult(new Intent(myThis, Results.class), 0);
            }
        });
    ...
    protected void onResume() {
        ...
        this.getActionBar().setTitle("Step 3");

        Context context = getApplicationContext();
        CharSequence text = "Place your smartphone on a flat surface on the rear axle that is parallel or perpendicular to the pinion.  Hold device steady and press SET to record measurement.";
        ...
        MainActivity.getInstance().urlTitle = "Help - Step 3";
        MainActivity.getInstance().urlString = "file:///android_asset/step3detail.html";
    }
...
*/
                ...
                MainActivity.getInstance().angle3 = rotatedAngleInDegrees;
            }
        }
    }
